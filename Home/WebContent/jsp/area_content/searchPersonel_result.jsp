...
<p align="center">
<s:form name="savesearchinfo" theme="simple" id="demo">
...
<p align="center">
<input type="button" value="员工登记" class="buttonstyle" onclick="getPart('<%=basePath%>jsp/area_content/grandchild31Id.jsp')"/>
...
<s:form name="ruzhiPersonnel" action="ruzhiPersonnel" theme="simple" method="post" id="demo2">
...
<td>
<s:autocompleter list="#{'保安':'保安','环卫工人':'环卫工人','绿化工人':'绿化工人','财务员':'财务员','处理人':'处理人','物业管理员':'物业管理员'}" theme="simple" name="personnel_worktype" listKey="key" listValue="value" value="保安" /><span>*</span>
</td>
</tr>
<tr>
<td align="center">
