...
public class LvhuaAction extends ActionSupport implements ServletRequestAware,
	...
	public void add_lvhua() {
		try {
			...
			Lvhua_serviceImpl lvhua_s = new Lvhua_serviceImpl();
			lvhua_s.add_lvhua(this.lvhua_area, this.lvhua_style,
					this.lvhua_fuzheren, this.lvhua_date, this.lvhua_status,
					this.lvhua_yanshouren, this.lvhua_memo);
			out.print("绿化/保洁登记成功");
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public String detail_lvhua() {
		Lvhua_serviceImpl lvhua_s = new Lvhua_serviceImpl();
		List<Lvhua> lvhua = lvhua_s.detail_lvhua(Integer.parseInt(request
				.getParameter("p")));
	...
	public void yanshou_lvhua() {
		try {
			...
			PrintWriter out = response.getWriter();
			Lvhua_serviceImpl lvhua_s = new Lvhua_serviceImpl();
			lvhua_s.yanshou_lvhua(Integer.parseInt(request.getParameter("p")),
					this.lvhua_yanshouren, "已验收", this.lvhua_memo);
			out.print("验收成功");
		} catch (Exception e) {
			e.printStackTrace();
		}
