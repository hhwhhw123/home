...
<tr>
<td>工作意项:</td>
<td><s:autocompleter list="#{'保安':'保安','环卫/绿化工':'环卫/绿化工','处理人':'处理人','物业管理员':'物业管理员'}" theme="simple" name="personnel_worktype" listKey="key" listValue="value" value="保安"/><span>*</span></td>
<td>手机号码:</td>
