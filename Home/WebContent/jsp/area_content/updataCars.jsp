...
<body>
<h1 align="center">更改停车信息</h1>
<p align="center">
<s:form name="updataCars" action="updataCars" id="demo" method="post" theme="simple">
...
<td ><input name="carmsg" value="<s:property value="carmsg"/>"/></td>
