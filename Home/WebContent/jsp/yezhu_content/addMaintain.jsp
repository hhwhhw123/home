...
<td><input name="maintain_thing" dataType="Require" msg="请输入投诉反馈类别" /></td>
</tr>

<tr>
<td align="center">投诉反馈原因:</td>
<td><textarea name="maintain_smemo" dataType="Require" msg="请输入投诉反馈原因" cols="32" rows="6"></textarea></td>
</tr>
</table>
<p align="center">
