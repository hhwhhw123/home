...
public class Notify_serviceImpl implements Notify_service {
	...
	@Override
	public void Add_notify(String content, Date date, String title, String uper, String lb, String zt) {
	...
	@Override
	public void Updata_notify(int id, String title, String content, Date date,String uper, String lb, String zt) {
		// TODO Auto-generated method stub
		Session session = sessionFactory.openSession();
		Transaction tx = null;
		try{
	...
	public List<Notify> new_notify() {
		...
		try{
			tx = session.beginTransaction();
			Query query = session.createQuery("from Notify n where n.zt='通过' order by n.notify_date DESC");
