...
<p align="center">
<input type="button" value="服务登记" class="buttonstyle" onclick="getPart('<%=basePath%>jsp/area_content/addMaintain.jsp')"/>
<input type="button" value="查看详情" class="buttonstyle" onclick="detailmaintain()"/>
<input type="button" value="删   除"  class="buttonstyle" onclick="deletemaintain()"/>
</p>
</s:form>
</body>
</html>