...
<p align="center">
<input type="button" class="buttonstyle" value="处理结果" onclick="dengjimaintain()"/>
<input type="button" class="buttonstyle" value="删   除" onclick="deletemaintain()"/>
</p>
</s:form>

<div id="jieguo" style="display: none" align="center">
<s:form name="resultMaintain" action="resultMaintain" id="demo" theme="simple" method="post">
