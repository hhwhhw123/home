...
<div align="center">
<s:form name="searchhomes" theme="simple" id="demo">
查询条件:
<%--<s:autocompleter list="#{'-栋楼-':'-栋楼-','A栋楼':'A栋楼','B栋楼':'B栋楼','C栋楼':'C栋楼','D栋楼':'D栋楼','E栋楼':'E栋楼','F栋楼':'F栋楼'}" theme="simple" name="Homes_lou" listKey="key" listValue="value"/>--%>
...
<p align="center">
<form name="addYezhu" action="addYezhu" id="demo2" method="post" onSubmit="return Validator.Validate(this,2)">
