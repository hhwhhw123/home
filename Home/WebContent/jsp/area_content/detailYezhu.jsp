...
<s:form name="detail_yezhu" action="detail_yezhu" theme="simple" method="post">
...
<form name="add_custom_account" action="add_custom_account" id="demo" method="get" onSubmit="return Validator.Validate(this,2)">
...
<td>
<input name="custom_password"  dataType="SafeString" msg="密码必须是6位以上字母和数字集合" type="password"/><span>*</span>
</td>
</tr>
...
<td>
<input name="Repeat_password" dataType="Repeat" to="custom_password" msg="密码不一致" type="password"/><span>*</span>
</td>
</tr>
</table>
