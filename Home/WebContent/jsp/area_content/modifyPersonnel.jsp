...
<body>
<s:form name="modifyPersonnel" action="modifyPersonnel" theme="simple" method="post" id="demo">
...
<td>
<s:autocompleter list="#{'保安':'保安','环卫工人':'环卫工人','绿化工人':'绿化工人','财务员':'财务员','处理人':'处理人','物业管理员':'物业管理员'}" theme="simple" name="personnel_worktype" listKey="key" listValue="value"/>
</td>
</tr>
