...
public interface Personnel_service {
	...
	public void Add_personnel(String name,int age,String sex,String idcard,
		...
		String oldwork,String worktype,String daozhimemo,String status);//员工登记
	
	public List<Personnel> List_personnel(int firstResult,int maxResult);//员工分页查询
	
	public int Personnel_count();//返回员工表总数量
	
	public List<Personnel> Detail_personnel(int id);//查询员工详情
	...
	public void Modify_personnel(int id,String name,int age,String sex,String idcard,
			String jiguan,String phone,String addr,String xueli,String gongling,
			String oldwork,String worktype,String daozhimemo);//修改员工信息
	
	public List<Personnel> Search_personnel(String name);//姓名查询
	
	public List worker_list(String worktype);//查询在职的员工姓名
}
