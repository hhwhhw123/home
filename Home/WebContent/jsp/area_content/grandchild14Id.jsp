...
<p align="center">
<input type="button" class="buttonstyle" value="新增新闻" onclick="getPart('<%=basePath%>jsp/area_content/addNotify.jsp')"/>
<input type="button" class="buttonstyle" value="修改新闻" onclick="modifynotify()"/>
<input type="button" class="buttonstyle" value="删除新闻" onclick="delnotify()"/>
</p>
</s:form>
</body>
</html>