...
<table align="center" border="1" width="80%" cellpadding="0" cellspacing="0" bordercolor="#99CC33" bordercolorlight="white" bordercolordark="#4BD52B"> 
...
<input type="button" value="返   回" class="buttonstyle" onclick="getPart_yezhu('yezhu_info.action?id=<%=session.getAttribute("yezhu_id")%>')"/>
</p>
</form>
